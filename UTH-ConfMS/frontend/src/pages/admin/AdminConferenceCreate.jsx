  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleCreate} className="submission-form" style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <h3 style={{ marginBottom: "1rem", fontSize: "1rem", fontWeight: 600, color: "#111827" }}>Danh sách chủ đề & Lịch trình</h3>
        <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: "12px", padding: "1.5rem", boxShadow: "0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)", marginBottom: "1.5rem" }}>
          ...
          <button type="button" className="btn-secondary table-action" onClick={addTrack} style={{ marginTop: "0.5rem", padding: "0.5rem 1rem", borderRadius: "6px" }}>+ Thêm chủ đề </button>
        </div>
