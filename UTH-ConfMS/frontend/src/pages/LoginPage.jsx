        ...
        <div className="auth-left">
          <div className="notice-container">
            <div className="notice-tabs">
              <span className={`tab ${activeTab === "general" ? "active" : ""}`} onClick={() => setActiveTab("general")}>
                {t('auth.notices.general')}
              </span>
              <span className={`tab ${activeTab === "training" ? "active" : ""}`} onClick={() => setActiveTab("training")}>
                {t('auth.notices.training')}
              </span>
              <span className={`tab ${activeTab === "ctct" ? "active" : ""}`} onClick={() => setActiveTab("ctct")}>
                {t('auth.notices.student')}
              </span>
            </div>
                ...
                <>
                  <div className="notice-item">
                    <div className="notice-text">
                      {t('auth.notices.deadline')}
                      <div className="date">11/12/2025</div>
                    </div>
                    <span className="detail">{t('app.view')}</span>
                  </div>
                  <div className="notice-item">
                    <div className="notice-text">
                      {t('auth.notices.schedule')}
